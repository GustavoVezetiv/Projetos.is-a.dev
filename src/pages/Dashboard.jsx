        ...
        <React.Fragment>
            ...
            <div className="flex flex-col items-center justify-center p-10 text-center max-w-3xl mx-auto mt-10">
                ...
                <h2 className="text-3xl font-bold mb-4 font-montserrat"> Gustavo Vezetiv</h2>
                    ...
                    <div id="bio-expanded-content" className={(!bioExpanded ? "hidden " : "") + "text-white/70 leading-relaxed font-inter space-y-3 mb-2"}>
                ...
                <button id="bio-toggle-btn" onClick={() => setBioExpanded(!bioExpanded)} className="px-4 py-2 text-sm font-bold text-cyan-400 hover:text-cyan-300 transition-all border border-cyan-400/50 rounded-lg mb-4 hover:border-cyan-300 flex items-center gap-2 hover:shadow-lg hover:shadow-cyan-500/20">
...
export default function Dashboard() {
    ...
    <main className="w-full h-full relative z-10">
        ...
        <section className="page-section min-h-screen h-full w-full flex flex-col items-center justify-center font-inter bg-transparent relative">

            <div id="v3-hero"
                className="h-screen flex flex-col justify-center items-center pb-24 animate-fadeIn transition-all duration-500 relative w-full">
